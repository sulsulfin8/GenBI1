                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="bg-white p-5 rounded-2xl shadow-sm border border-gray-200">
                                    <div class="flex items-center justify-between mb-4 border-b border-gray-100 pb-3">
                                        <label
                                            class="block text-xs font-black text-gray-800 uppercase tracking-tight">Pelanggaran
                                            & Penambahan Poin</label>
                                ...
                                <div class="bg-white p-5 rounded-2xl shadow-sm border border-gray-200">
                                    <div class="flex items-center justify-between mb-4 border-b border-gray-100 pb-3">
                                        <label
                                            class="block text-xs font-black text-gray-800 uppercase tracking-tight">Aturan
                                            QRIS (Target Bulanan)</label>
                                ...
                                <div class="bg-white p-5 rounded-2xl shadow-sm border border-gray-200">
                                    <div class="flex items-center justify-between mb-4 border-b border-gray-100 pb-3">
                                        <label
                                            class="block text-xs font-black text-gray-800 uppercase tracking-tight">Apresiasi
                                ...
                                <div class="bg-white p-5 rounded-2xl shadow-sm border border-gray-200">
                                    <div class="flex items-center justify-between mb-4 border-b border-gray-100 pb-3">
                                        <label
                                            class="block text-xs font-black text-gray-800 uppercase tracking-tight">Ambang
                                            Batas Peringatan (SP)</label>
