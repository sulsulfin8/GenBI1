    ...
    <div class="bg-white rounded-2xl p-6 md:p-8 shadow-soft border border-gray-50 mb-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div
                ...
                <p class="text-sm text-gray-600 leading-relaxed">Terdiri dari Ketua, Sekretaris, dan Bendahara. Bertanggung
                    jawab atas jalannya roda organisasi, administrasi, sirkulasi keuangan, serta mengambil keputusan
                    strategis komisariat.</p>
            </div>
            <div
                ...
                <p class="text-sm text-blue-800/80 leading-relaxed">Berfokus pada peningkatan kapasitas akademik anggota
                    dan masyarakat, serta pelestarian nilai-nilai kebudayaan lokal melalui kegiatan seminar, diskusi, dan
                    pelatihan.</p>
            </div>
            <div
                ...
                <p class="text-sm text-emerald-800/80 leading-relaxed">Menjadi jembatan antara GenBI dan masyarakat.
                    Menyelenggarakan kegiatan sosial, bantuan kemanusiaan, dan program pemberdayaan untuk menebar energi
                    positif secara langsung.</p>
            </div>
            <div
                ...
                <p class="text-sm text-purple-800/80 leading-relaxed">Divisi Publikasi, Dekorasi & Dokumentasi. Menjadi
                    ujung tombak penyebaran informasi, mengelola media sosial, dan mendokumentasikan setiap momen penting
                    kegiatan GenBI.</p>
            </div>
            <div
                ...
                <p class="text-sm text-orange-800/80 leading-relaxed">Menumbuhkan jiwa *entrepreneurship* anggota.
                    Menggagas ide bisnis kreatif, pencarian dana mandiri (Danus), dan mendorong kemandirian finansial
                    organisasi.</p>
            </div>
            <div
                ...
                <p class="text-sm text-teal-800/80 leading-relaxed">Bergerak di bidang pelestarian alam. Menginisiasi
                    program penghijauan, kampanye sadar sampah, dan menanamkan kepedulian lingkungan kepada anggota maupun
            ...
            <div
                ...
                <div
                    ...
                    <div class="relative z-10 flex items-center gap-3">
                        ...
                        <h3 class="text-xl font-black text-gray-800 tracking-tight">Edit Syarat & Dokumen Beasiswa</h3>
                    </div>
                    ...
                    <div class="p-6 sm:p-8 space-y-6 overflow-y-auto hide-scrollbar flex-1">
                        <div
                            ...
                            <p class="text-sm text-blue-900 font-medium leading-relaxed">
                                <b class="text-blue-700">Panduan:</b> Tidak perlu repot menekan "Enter" berulang kali.
                                Cukup klik tombol <b>"+ Tambah"</b> untuk membuat kotak poin baru secara spesifik. Nomor
        ...
        <div
            ...
            <div class="overflow-y-auto hide-scrollbar flex-1 relative z-10 bg-gray-50/50 p-6 sm:p-8 pt-10">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div class="space-y-4">
                        <h4 class="text-red-600 font-black uppercase text-xs tracking-widest flex items-center gap-2"><span
                                class="w-2 h-2 rounded-full bg-red-500"></span> Pelanggaran & Penambahan Poin</h4>
                        <div
                        ...
                        @foreach ($kriteriaArray as $kriteria)
                            @if (trim($kriteria) != '')
                                ...
                                <div
                                    ...
                                    <p class="text-sm text-gray-700 font-medium leading-relaxed">{{ trim($kriteria) }}</p>
                                </div>
                            @endif
                        @endforeach
                    </div>
                        ...
                        @foreach ($dokumenArray as $dokumen)
                            @if (trim($dokumen) != '')
                                @php
                                    ...
                                    if (
                                    ...
                                    } elseif (str_contains($lowerText, 'kk') || str_contains($lowerText, 'keluarga')) {
                                        $icon =
                                            '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path>';
                                    } elseif (
                                        ...
                                        $icon =
                                            '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>';
                                    } elseif (str_contains($lowerText, 'khs') || str_contains($lowerText, 'studi')) {
                                        $icon =
                        ...
                        <div
                            ...
                            <div
                                ...
                                <div class="flex items-center gap-2 text-gray-700"><svg
                                        class="w-4 h-4 text-blue-500 flex-shrink-0" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
