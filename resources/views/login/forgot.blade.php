                    ...
                    <div>
                        ...
                        <div class="relative group">
                            ...
                            <input type="password" name="password" id="new_password" required
                                ...
                                class="w-full bg-gray-50 border border-gray-200 rounded-xl py-3.5 pl-11 pr-12 focus:outline-none focus:border-primary-blue focus:ring-4 focus:ring-primary-blue/15 text-sm transition-all duration-300 font-semibold text-gray-800 focus:bg-white placeholder-gray-400">
                            
                            <!-- Toggle Button -->
                            <button type="button" onclick="togglePasswordVisibility('new_password', this)"
                                class="absolute inset-y-0 right-0 flex items-center pr-4 text-gray-400 hover:text-primary-blue transition-colors focus:outline-none">
                                <!-- Eye Icon -->
